...
Our survey where filled out by seven individuals, all in some way connected to our current project at Ericsson. We chose the participants based on their previous knowledge of system integration. Both with ESB and other techniques. Four of the participants are in our group and are currently working actively with integration using an ESB from Mulesoft. The other three are employed at Ericsson, which we have got in contact with while performing our project at Ericsson.
