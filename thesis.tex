...
2 & Is it hard to decide which part of the system functionality really belongs in the ESB? & 3 (\%) & 3 (0\%) & 1 (\%)\\ \hline %undecided 1
\end{tabular}
\end{center}
...
\hline
Nr & Question & Yes & No \\ \hline
3 & Do you experience an issue with slower communication between nodes because of the extra steps that comes with a ESB? & 3 (\%) & 4 (0\%) \\ \hline
\end{tabular}
\end{center}
...
\hline
Nr & Question & Yes & No \\ \hline
4 & Have you ever migrated older, integrated systems to the ESB architecture? & 0 (\%) & 7 (0\%) \\ \hline
\end{tabular}
\end{center}
...
\hline
Nr & Question & Yes & No & Undecided\\ \hline
5 & Are you able to get support or find information to resolve the issues thatare encountered during integration? & 5 (\%) & 1 (0\%) & 1  (0\%)\\ \hline %undecided 1
\end{tabular}
\end{center}
...
\hline
Nr & Question & Yes & No \\ \hline
6 & Have you encountered any issues, apart from the ones mentioned in this questionaire, when working with ESB integration? & 5 (\%) & 2 (0\%) \\ \hline
\end{tabular}
\end{center}
